...
const Carousels = () => {
  ...
  return (
    ...
    <div className="carousel_section">
      <h1 className="carousel_head">Choose The Best Teacher Around The Globe</h1>
      <Carousel ref={refContainer1} breakPoints={breakPoints} showArrows={false}>
      ...
      <div className="carousel_center">
        {" "}
        <button className="carousel_teacher_prev_btn" onClick={() => refContainer1.current.slidePrev()}>
          <ArrowBackIcon />
        </button>
        <button className="carousel_teacher_next_btn" onClick={() => refContainer1.current.slideNext()}>
          <ArrowForwardIcon />
        </button>
      </div>
      <h1 className="carousel_head carousel_t">Listen from our learners</h1>
      <h3 className="carousel_small">Check out these reviews</h3>
      <Carousel ref={refContainer2} breakPoints={breakPoints1} showArrows={false}>
        <div className="carousel_review carousel_center">
          <h3 className="carousel_review_text">
            My overall experience with Neurolingua has been wonderful. They have great teachers, and a great platform with great features.
          </h3>
          <h2>Bharath</h2>
        </div>
        <div className="carousel_review carousel_center">
          <h3 className="carousel_review_text">
            It’s great to chat to a native speaker, to activate the target language & get all the help the Neurolingua platform offers.
          </h3>
          <h2>Venkat</h2>
        </div>
        <div className="carousel_review carousel_center">
      ...
      <div className="carousel_center" style={{marginTop: '40px'}}>
        {" "}
        <button className="carousel_teacher_prev_btn" onClick={() => refContainer2.current.slidePrev()}>
          <ArrowBackIcon />
        </button>
        <button className="carousel_teacher_next_btn" onClick={() => refContainer2.current.slideNext()}>
          <ArrowForwardIcon />
        </button>
      </div>
    </div>
