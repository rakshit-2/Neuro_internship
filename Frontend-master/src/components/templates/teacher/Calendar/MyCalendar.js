...
function MyCalendar(props) {
  ...
  function Event({ event }) {
    return (
      <div className="event">
        <p> {convertFrom24To12Format(String(event.start).slice(16, 21)) + "-" + convertFrom24To12Format(String(event.end).slice(16, 21))}</p>
      </div>
    );
  }
  ...
  return (
    <>
      ...
      <div
        style={{ marginTop: "10px", borderRadius: "10px", width: '100%', backgroundColor: "#fefeff", padding: width >= 700 ? "20px" : '5px' }}
