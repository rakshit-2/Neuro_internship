  ...
  return (
    <>
      {showConfirmationModal && selectedCourse ? (
        <>
          <DeleteConfirmationModal showModal={showConfirmationModal} handleModal={setShowConfirmationModal} selectedCourse={selectedCourse} setApiCalled={setApiCalled} />
        </>
      ) : (
        <></>
      )}

      <CreateCourseModal showModal={showCreateCourseModal} setModal={setShowCreateCourseModal} setApiCalled={setApiCalled} />

      <CreateLesson showModal={showCreateLessonModal} setModal={setShowCreateLessonModal} modalType={createLessonModalType} />
      ...
      <main className={stylesPrev.mainSection}>
          ...
          <div>
            <div className={styles.sessionTabs}>
              ...
              <div className={styles.arrowIcon} onClick={() => setMobileDropdown(!mobileDropdown)}>
                {mobileDropdown ? <i class="fas fa-caret-up"></i> : <i class="fas fa-caret-down"></i>}
              </div>
            </div>
            {mobileDropdown ? (
        ...
        <div className={styles.scrollBarNone} style={{ maxWidth: '800px', marginTop: '10px', height: '75vh ', overflowY: 'scroll' }}>
