                ...
                <div className={styles.modal}>
                    ...
                    {width >= 992 ?
                        <>
                            ...
                            {page === '1A' ?
                                <Page1A setRescheduleModal={setRescheduleModal} setRescheduleSlot={setRescheduleSlot} setPage={setPage}/>
                                :
                                <></>
                            }
                            {page === '1B' ?
        ...
        {/* <button onClick={()=>{setPage(1)}}>back</button> */}
            <div style={{ marginTop: '20px', border: '1px solid #d6d6d7', padding: '10px', backgroundColor: '#f1f1f1', borderRadius: '5px' }}>
                ...
                <div style={{ marginTop: '10px', display: 'flex', justifyContent: 'space-around', alignItems: 'center' }}>
                    <img src={english} alt="language_flag" style={{ borderRadius: '50%', width: '80px' }} />
                    <div>
                        <div style={{ fontSize: '18px', color: '#359cd7' }}>Unscheduled</div>
