    ...
    return (
        <>
            {width >= 992 ?
                ...
                :
                <main className={styles.mainSection}>
                    <div style={{ fontSize: '24px', fontWeight: '500', textAlign: 'center', padding: '10px 0', border: '1px solid', borderRadius: '10px' }}>Welcome Bharath!</div>
        ...
        <div className={styles.row}>
            {widgets.map((item, index) => (
                <div className={item.title === activeTab ? styles.firstRowTabActive : styles.firstRowTab} key={index} onClick={() => setActiveTab(item.title)}>
                    ...
                    <div>
                        <img src={item.icon} alt="icon" fill="pink" style={{ width: '30px', filter: 'filter: invert(48%) sepia(79%) saturate(2476%) hue-rotate(86deg) brightness(118%) contrast(119%)' }} />
        ...
        <div style={{ marginTop: width >= 992 ? '0' : '20px', padding: width >= 992 ? '20px' : '10px', width: '100%', borderRadius: '20px', border: '1px solid' }}>
            <div style={{ display: width >= 992 ? 'flex' : 'block', justifyContent: 'space-around', alignItems: 'center' }}>
                ...
                <div style={{ marginTop: width >= 992 ? '' : '20px', display: width >= 992 ? '' : 'flex', justifyContent: 'center' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', gap: '10px', alignItems: 'center', padding: '5px 20px', border: '1px solid #9ECDE6', borderRadius: '30px' }}>
                        Week
                        <img src={down_arrow} alt="down_arrow_img" style={{ width: '20px' }} />
                    </div>
                </div>
            </div>
    ...
    return (
        <div style={{ width: '20%', position: 'absolute', top: '0', right: '25px' }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between', borderRadius: '20px', margin: '10px', width: '20vw', minHeight: '97vh', backgroundColor: 'rgba(158, 205, 230, 0.15)', position: 'fixed' }}>
                <div style={{ marginTop: '10px', alignSelf: 'flex-end', display: 'flex', alignItems: 'center', justifyContent: 'flex-end' }}>
                    <i class="far fa-comment fa-2x"></i>
                    <img src={notification}alt="notification_img" style={{ width: '35px', marginLeft: '30px', marginRight: '20px' }} />
                </div>
                <div>
                    ...
                    <div style={{ textAlign: 'center', marginBottom: '20px' }}>{`Welcome ${teacherData && teacherData.firstName.data}`}</div>
                    <div style={{ textAlign: 'center', fontWeight: 'bold', fontSize: '20px', marginBottom: '20px' }}>Upcoming Class</div>
                    <div style={{ padding: '20px 0', color: '#fff', backgroundColor: '#9ECDE6', width: '20vw', borderRadius: '20px' }}>
                        <div style={{ fontWeight: 'bold', textAlign: 'center' }}>French</div>
