    ...
    <>
      ...
      >
        ...
        <td className={styles.col2}>
          {props.verificationType === "Teacher" ? (
            <>
              <img src={props.teacher.teacherProfilePic.data} alt="" style={{ borderRadius: '50%', border: '3px solid grey' }} />
        ...
        <td className={styles.col4}>
          {props.verificationType === "Teacher" ? (
            <>
              <a href={props.teacher.videoURL.data} target="_blank" rel="noreferrer">
        ...
        <td className={styles.col5}>
          {props.verificationType === "Teacher" ? (
            <>
              <a href={"mailto:" + props.teacher.userId.email} title={props.teacher.userId.email} onClick={(e) => handleCopyIconData(e, props.teacher.userId.email)}>
                <i className="fas fa-envelope"></i>
              </a>
              <a href={"tel:" + props.teacher.mobileNumber.data} title={props.teacher.mobileNumber.data} onClick={(e) => handleCopyIconData(e, props.teacher.mobileNumber.data)}>
        ...
        <td className={styles.col6}>
          {props.verificationType === "Teacher" ? <>{props.teacher.fromCountry.data}</> : <>{new Date().toDateString()}</>}
        </td>
      </tr>
    </>
  );
