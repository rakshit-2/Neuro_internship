...
const TeachersData = (props) => {
  ...
  }, [props.selectedCourse, props.selectedTeacher, formValues, props.verificationType]);
  ...
  function handleChange(e) {
    ...
    //   newForm["region"][e.target.name]["is_verified"] = e.target.checked;
    // } else
  ...
  const deleteUser = async (id) => {
    const uid = { id: id };
    const deleted = await dispatch(deleteUsers(uid));
    props.refresh();
  }
  return (
    <>
        ...
        <div className={styles.teachersData}>
          ...
          <div className={props.verificationType === "Teacher" ? styles.teacherProfile : styles.courseImg}>
            ...
            {props.verificationType === "Teacher" ? (
              <>
                <input type="checkbox" onClick={handleChange} name="teacherProfilePic" defaultChecked={formValues.approvalStatus === 'verified' && formValues.teacherProfilePic.is_verified} />
          ...
          <div className={styles.basicDetails}>
            {props.verificationType === "Teacher" ? (
              ...
              <>
                <div>
                  <input type="checkbox" onClick={handleChange} name="firstName" defaultChecked={formValues.approvalStatus === 'verified' && formValues.firstName.is_verified} />
          ...
          <div className={styles.otherDetailsContainer}>
            {props.verificationType === "Teacher" ? (
              ...
              <>
                ...
                <div className={styles.otherDetails}>
                  <input type="checkbox" onClick={handleChange} name="dob" defaultChecked={formValues.approvalStatus === 'verified' && formValues.dob.is_verified} />
