    ...
    <>
      {width >= 992 ? (
        <div style={{ display: "flex", marginBottom: "20px" }}>
          ...
          >
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", gap: "0px", alignItems: "center" }}>
              <div onClick={() => showTeacherProfile()} style={{ cursor: "pointer", width: '100px', height: '100px' }}>
                <img src={course.courseImage.data} alt="teacher_img" style={{ border: '3px solid grey', objectFit: 'cover', borderRadius: "50%", width: '100%', height: '100%' }} />
                <img src={"/flags/" + course.language.data.toLowerCase() + ".png"} alt="language_flag" style={{ marginLeft: "-35px", width: "30px", height: "30px" }} />
              </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", gap: "10px", alignItems: "flex-start" }}>
              ...
              <div
                style={{
                  ...
                  borderImage: "linear-gradient(to right, #fe1848 30%, #FFF 10%) 100% 1",
                }}
              >
              ...
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <span>
                  ...
                  <div style={{ color: "#454544", fontSize: "18px" }}>{course.userId.onType.languageTeach[0].data}
            ...
            <div onClick={() => showCalender()} style={{ width: '170px', display: "flex", flexDirection: "column", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <div style={{ backgroundColor: "#fefeff", borderRadius: "0 10px 10px 0", padding: "1vw" }}>
