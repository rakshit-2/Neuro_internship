...
import { langOptions, courseOptions, timeOptions, dayOptions } from './filterUtils';
...
function Filters(props) {
    ...
    var { focus, setFocus, width, setCoursesArr, lang, setLang, reset, resetRef } = props;
    ...
    React.useEffect(() => {
        ...
        const apiStr = `?language=${currFilters.language}&courseType=${currFilters.courseT.replace(" ", "%20")}&startPrice=${currFilters.startPrice}&endPrice=${currFilters.endPrice}&motherTongue=${currFilters.motherT}&country=${currFilters.country}&page=${currFilters.page}&limit=${currFilters.limit}`;
    ...
    }, [dispatch, lang, courseType, availability, minPrice, maxPrice, motherTongue, from])
